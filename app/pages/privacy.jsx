      ...
      <div className="container max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p>
            ...
            and safeguard your information when you use our online tools and
            services.
          </p>
          ...
          <p>
            ...
            how you use our tools, including browser type, time spent on the site,
          ...
          <p>
            ...
            authentication information and track API call volume for rate limiting
            purposes.
          </p>
          ...
          <h2 className="text-xl font-semibold mt-8">5. Cookies and Tracking</h2>
          <p>
            We use essential cookies to ensure the proper functioning of our site.
            We also use analytics cookies to understand how visitors interact with
            our tools, which helps us improve them. You can control cookie
          ...
          <p>
            ...
            infrastructure needs. These services have their own privacy policies,
            and we recommend reviewing them for a complete understanding of how
            your data might be processed.
          </p>
          ...
          <p>
            ...
            will post the updated policy on this page with a revised "Last
            updated" date.
          </p>
